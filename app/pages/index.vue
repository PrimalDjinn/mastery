	...
	<section>
		<div class="ml-[5vw]">
			...
			>
				...
				<div class="w-full flex justify-between mt-4 pr-4">
					<button class="glow-join bg-white border-peach border-4 w-40 h-12 font-bold text-peach">
						Join Now
					</button>
